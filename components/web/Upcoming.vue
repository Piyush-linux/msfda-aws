<template>
    <div class="m-10 h-screen">
        <div class="text-center text-3xl uppercase font-bold">Upcoming Courses</div>
        <div class="flex">
            ...
            <div class="w-1/3 p-10">
                ...
                <!-- <iframe src="https://drive.google.com/file/d/1TdsPptt66OPvjPXczU3G4qbqbZW_VhbM/preview" width="640" height="480" allow="autoplay"></iframe> -->
                <iframe id="calender" src="https://drive.google.com/file/d/1TdsPptt66OPvjPXczU3G4qbqbZW_VhbM/preview" allow="autoplay"></iframe>
            </div>
        </div> 
    </div>
</template>
...
// await(await fetch(`${runtimeConfig.public.apiBase}/centres`)).json()
// let url= 
// console.log(runtimeConfig)
// let url= `http://localhost:1337/api/upcoming?populate=courses`
let { data: courses } = await( await fetch(`${runtimeConfig.public.apiBase}/upcoming?populate=courses`)).json()
// console.log(data)
// let courses = [{
